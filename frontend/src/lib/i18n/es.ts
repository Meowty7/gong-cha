...
export const es = {
  ...
  dashboard: {
    ...
    openCapacity: 'Calcular capacidad',
    openDemand: 'Calcular requerimientos',
    openEvent: 'Planificar evento',
    openProduction: 'Simular producción',
    refresh: 'Actualizar indicadores',
    usageTitle: 'Insumos más usados',
    usageDescription: 'Cuántas recetas dependen de cada insumo',
    usageUnit: 'recetas',
    missingTitle: 'Insumos sin existencias',
    missingDescription: 'Aparecen en recetas pero no tienen inventario',
    missingEmpty: 'Todos los insumos de receta tienen existencias.',
    ingredient: 'Insumo',
    usedIn: 'Recetas',
    stock: 'Existencias',
    noStock: 'Sin stock',
  ...
  errors: {
    ...
    network: 'No se pudo comunicar con el servidor. Revisa la conexión e inténtalo de nuevo.',
  ...
  product: {
    ...
    type: 'Tipo',
    unit: 'Unidad',
    unitLocked: 'La unidad se define al crear el producto y no se puede cambiar.',
  ...
  recipes: {
    ...
    cycleBadge: 'Ciclo',
    incompleteBadge: 'Sin receta',
    saving: 'Guardando...',
    noMoreComponents: 'No hay más componentes disponibles',
    selfComponentHint: 'El producto resultante no aparece como componente: eso formaría un ciclo.',
    loadingList: 'Cargando recetas...',
    loadingDetail: 'Cargando composición...',
    loadError: 'No se pudieron cargar las recetas',
    createSuccess: 'Receta creada',
    updateSuccess: 'Receta actualizada',
    deleteSuccess: 'Receta eliminada',
  ...
  calculations: {
    ...
    quantity: 'Cantidad',
    quantityToProduce: 'Cantidad que quieres producir',
    results: 'Resultado',
    resultLabel: 'Resultado del cálculo',
    capacityAnswer: 'Puedes preparar',
    requirementsAnswer: 'Insumos necesarios para preparar',
    limitedBy: 'El inventario está limitado por',
    calculateCapacity: 'Calcular capacidad',
    calculateRequirements: 'Calcular insumos',
    advancedOptions: 'Opciones avanzadas',
    advancedHint: 'Úsalas solo para probar existencias distintas al inventario actual.',
    inventoryDetail: 'Ver detalle del inventario restante',
    recipeDetail: 'Ver componentes directos de la receta',
    totalRequirements: 'Insumos totales necesarios',
    ...
    consumedCaption: 'Consumo al producir el máximo de unidades completas',
    calculatedAt: 'Calculado el {when}',
    historyTitle: 'Cálculos recientes',
    historyEmpty: 'Aún no hay cálculos guardados.',
    historyType: 'Tipo',
    historySummary: 'Resumen',
    typeDirect: 'Capacidad',
    typeInverse: 'Insumos',
    typeEvent: 'Evento',
    typeSimulation: 'Simulación',
  ...
  production: {
    ...
    quantityHint: 'Usa un número mayor que cero.',
